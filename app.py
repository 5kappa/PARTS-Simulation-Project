...
if saved_rigs:
    ...
    if load_name:
        ...
        if ld_col1.button("Load", type="primary", use_container_width=True):
            ...
            st.session_state.loaded_indices = loaded
            st.rerun()
...
if not events_df.empty:
    ...
    preview_df = events_df[['EventName', 'target_type', 'Probability', 'Multiplier']].copy()
    preview_df.rename(columns={'target_type': 'Affected Parts'}, inplace=True)
